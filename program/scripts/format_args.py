...
def format_args(input_file, proof_path):
    """Reads arguments from JSON file and returns formatted result as a list of hex values.
    Output is compatible with the Scarb runner arguments format.
    ...
    args = format_args_to_cairo_serde(input_file)

    proof_data = json.load(open(proof_path))
    args.extend(proof_data)
...
if __name__ == "__main__":
    ...
    print(format_args(args.input_file, args.proof_path))
