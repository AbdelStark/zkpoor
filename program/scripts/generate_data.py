...
def resolve_input(input: dict, previous_outputs: dict):
    ...
    if input.get("coinbase"):
        ...
        if previous_outputs:
            ...
            # TODO: remove this
            # we do this to speed up the block fetcing and because we don't really need the outpoint
            # since we don't have the utreexo to verify it anyways
            previous_output = dummy_outpoint(input)
        return {
